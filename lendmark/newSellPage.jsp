		...
		filesArr.forEach(function(f){
			...
			reader.onload = function(e){
				var html = "<li draggable='false' class='append-img'>"
					...
					+" <img src="+e.target.result+" alt='상품이미지' id='img-'"+index+">"
					+" <button type='button' id='append-delete-button-"+index+"'></button>"
					+"</li>";
				...
				<ul class="column-box">
					<li class="image-column">
						<div class="img-column-title">
							상품이미지<span>*</span><small>(${asd }/12)</small>
						</div>
						<div class="img-column-content">
							<ul class="img-content-box">
								<li class="image-upload-box">이미지 등록<input type="file" id="input-imgs"
									accept="image/jpg, image/jpeg, image/png" multiple="multiple" required="required">
								</li>
								...
								<div class="category-select">
									...
									<ul class="category-select-menu">
										<li class="each-category">
											<button type="button" class="each-category-button" value="fassion">패션</button>
										</li>
										<li class="each-category">
					...
					<li class="availablity-column-box">
						...
						<div class="availablity-content-box">
							<div class="availablity-content-inner-box">
								<label for="구매가능" class="availablity">
									<input id="구매가능" type="radio" value="pos" name="buy-radio" >판매가능
								</label>
								<label for="구매불가" class="availablity">
									<input id="구매불가" type="radio" name="buy-radio" value="impos" checked>판매불가
								</label>
							</div>
						</div>
					</li>
					<li class="availablity-column-box">
						...
						<div class="availablity-content-box">
							<div class="availablity-content-inner-box">
								<label for="교환불가" class="availablity">
									<input id="교환불가" type="radio" value="impos" name="bargain-avail" checked>제안불가
								</label>
								<label for="교환가능" class="availablity">
									<input id="교환가능" type="radio" value="pos" name="bargain-avail">제안가능
								</label>
							</div>
						</div>
					</li>
					...
					<li class="availablity-column-box">
						...
						<div class="price-box">
							<div class="price-inner-box">
								<input type="text" placeholder="숫자만 입력해주세요." name="minimum"
					...
					<li class="availablity-column-box">
						...
						<div class="price-box">
							<div class="price-inner-box">
								<input type="text" placeholder="숫자만 입력해주세요." name = "maximum"
